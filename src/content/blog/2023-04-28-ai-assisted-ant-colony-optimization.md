...
![[Image generated by Dall-E using Bing]]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img1.jpeg)
...
![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img2.png)

OK, this was not unexpected. GPT-4 is familiar with TSP. So let us generate a test data-set with a few cities.

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img3.png)

That’s great but I needed something to test a proof of concept.

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img4.png)

That looks pretty good, lets test it in a Jupyter notebook

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img5.png)

It works! It would be better with a plot though.

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img6.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img7.png)
...
![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img8.png)

I wanted it to solve the problem for me. It wrote the code for a simple nearest neighbor algorithm.

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img9.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img10.png)

I copied the code and ran it in the Jupyter notebook.

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img11.png)

The code works.

Now I wanted to see if it understood Ant Colony optimization.

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img12.png)

Naturally, I asked it to write the code for me.

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img13.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img14.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img15.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img16.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img17.png)

Using the code without any changes produces the result I was looking for.

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img18.png)
...
![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img19.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img20.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img21.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img22.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img23.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img24.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img25.png)

![]({{ site.url }}/images/ai-assisted-ant-colony-optimization-img26.png)
